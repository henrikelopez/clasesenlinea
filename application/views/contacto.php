<div class="top-row">
            ...
            <div class="wrapper indent-top">
            	<article class="grid_7 suffix_1 prefix_1 alpha">
                    ...
                    <dl class="adress">
                        <dt>Guadalajara, Jalisco - México</dt>
                        <dd><span>Email:</span><a href="#">contacto@clasesenlinea.mx</a></dd>
                    </dl>  
                </article>
                <article class="grid_14 suffix_1 omega">
                    ...
                    <form id="contact-form" method="post">
                      <fieldset>
                        ...
                        <div class="btns">
                            <a class="link" onClick="document.getElementById('contact-form').reset()">Nuevo</a>
                            <a class="link" onClick="document.getElementById('contact-form').submit()">Enviar</a> 
                        </div>
                      </fieldset>
                    </form>
                </article>
